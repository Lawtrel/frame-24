...
export const AuthApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    authControllerForgotPasswordV1: async (
     ...
     * @throws {RequiredError}
     */
    authControllerRegisterV1: async (
     ...
     * @throws {RequiredError}
     */
    authControllerResetPasswordV1: async (
...
export const AuthApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async authControllerForgotPasswordV1(
      forgotPasswordDto: ForgotPasswordDto,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authControllerForgotPasswordV1(
          forgotPasswordDto,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AuthApi.authControllerForgotPasswordV1"]?.[
     ...
     * @throws {RequiredError}
     */
    async authControllerRegisterV1(
      registerDto: RegisterDto,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RegisterResponseDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authControllerRegisterV1(
          registerDto,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AuthApi.authControllerRegisterV1"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async authControllerResetPasswordV1(
      resetPasswordDto: ResetPasswordDto,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authControllerResetPasswordV1(
          resetPasswordDto,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AuthApi.authControllerResetPasswordV1"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const AuthApiFactory = function (
  ...
  return {
     ...
     */
    authControllerForgotPasswordV1(
      requestParameters: AuthApiAuthControllerForgotPasswordV1Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<any> {
      return localVarFp
        .authControllerForgotPasswordV1(
          requestParameters.forgotPasswordDto,
          options,
        )
    ...
    authControllerRegisterV1(
      requestParameters: AuthApiAuthControllerRegisterV1Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<RegisterResponseDto> {
      return localVarFp
        .authControllerRegisterV1(requestParameters.registerDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Finaliza o processo de redefinição usando token recebido por email.
     ...
     */
    authControllerResetPasswordV1(
      requestParameters: AuthApiAuthControllerResetPasswordV1Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<any> {
      return localVarFp
        .authControllerResetPasswordV1(
          requestParameters.resetPasswordDto,
          options,
        )
        .then((request) => request(axios, basePath));
    },
