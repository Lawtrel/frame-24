...
export const AppApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    appControllerHealthCheck: async (
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.appControllerGetRoot(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AppApi.appControllerGetRoot"]?.[
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.appControllerHealthCheck(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AppApi.appControllerHealthCheck"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
