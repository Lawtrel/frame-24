...
export class CashFlowEntriesController {
    ...
    @ApiResponse({ status: 201, description: 'Cash flow entry created successfully' })
    async create(
    ...
    @ApiResponse({ status: 200, description: 'Cash flow entries retrieved successfully' })
    async findAll(
        @CurrentUser() user: RequestUser,
    ...
    @ApiResponse({ status: 200, description: 'Cash flow entry retrieved successfully' })
