...
export class CustomerPositionQueryDto extends createZodDto(CustomerPositionQuerySchema) { }
...
export class SupplierPositionQueryDto extends createZodDto(SupplierPositionQuerySchema) { }
