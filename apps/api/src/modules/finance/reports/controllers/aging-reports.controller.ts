...
export class AgingReportsController {
    ...
    getCustomerPositionById(
        ...
        return this.positionService.getCustomerPositionById(user.company_id, customer_id);
    }
    ...
    getSupplierPositionById(
        ...
        return this.positionService.getSupplierPositionById(user.company_id, supplier_id);
    }
}
