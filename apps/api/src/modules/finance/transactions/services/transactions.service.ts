...
export class TransactionsService {
    ...
    @Transactional()
    async settleReceivable(company_id: string, user_id: string, dto: CreateReceivableTransactionDto) {
        const account = await this.receivablesRepository.findById(dto.account_receivable_id, company_id);
    ...
    @Transactional()
    async settlePayable(company_id: string, user_id: string, dto: CreatePayableTransactionDto) {
        const account = await this.payablesRepository.findById(dto.account_payable_id, company_id);
