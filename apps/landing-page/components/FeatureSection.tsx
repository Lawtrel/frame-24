...
const FeaturesSection = () => {
  ...
  return (
    <section className="py-28 md:py-40 bg-gray-950 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(255,0,0,0.15),_transparent_60%)] pointer-events-none"></div>
      <div
        className="absolute inset-0 [background-image:linear-gradient(to_right,rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.05)_1px,transparent_1px)]
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-20">
          Cada módulo do ecossistema{" "}
          <span className="text-red-500 font-semibold">Frame24 ERP </span>
          atua em sinergia total — conectando bilheteria, estoque, programação e
        ...
        <div className="relative h-[640px] w-full mx-auto max-w-5xl">
          <div className="absolute inset-0 flex items-center justify-center">
            <div
              className="w-64 h-64 bg-red-900/10 rounded-full border border-red-700/40 backdrop-blur-md
