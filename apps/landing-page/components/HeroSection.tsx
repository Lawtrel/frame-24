        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-center">
          ...
          <div className="lg:col-span-6 xl:col-span-5 text-center lg:text-left space-y-8">
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              Uma plataforma única para controle total de bilheteria, estoque,
              programação e relatórios financeiros — com dashboards analíticos
              em tempo real.
            </p>
          ...
          <div className="mt-20 lg:mt-0 lg:col-span-6 xl:col-span-7 flex justify-center lg:justify-end relative">
            {/* Aura */}
            <div
              className="absolute inset-x-1/4 top-1/4 h-2/3 -z-10
                                        bg-red-600/20 rounded-full blur-3xl opacity-60"
            ></div>
            ...
            <div className="relative w-full max-w-2xl h-[520px] lg:h-[620px]">
              {/* Desktop */}
              <div
                className="absolute top-0 left-0 w-3/4 transform -rotate-6
              ...
              >
                <div className="aspect-video bg-gray-900 border border-gray-700 rounded-xl overflow-hidden">
                  <span
                    className="block w-full h-full bg-gradient-to-br from-red-900/10 via-gray-900 to-gray-950
              ...
              {/* Tablet */}
              <div
                className="absolute top-1/3 right-0 w-1/3 transform rotate-12 scale-95
              ...
              >
                <div className="aspect-[4/3] bg-gray-900 border border-gray-700 rounded-lg overflow-hidden">
                  <span
                    className="block w-full h-full bg-gradient-to-br from-red-800/10 via-gray-900 to-gray-950
              ...
              {/* Mobile */}
              <div
                className="absolute bottom-4 right-1/4 w-1/4 transform scale-110
              ...
              >
                <div className="aspect-[9/16] bg-gray-900 border-4 border-gray-700 rounded-2xl overflow-hidden">
                  <span
                    className="block w-full h-full bg-gradient-to-b from-red-900/20 via-gray-900 to-gray-950
                                                     flex items-center justify-center text-xs text-gray-400 font-medium"
                  >
